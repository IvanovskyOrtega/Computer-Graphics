...
int main(int argc, char *argv[])
{
	if (argc == 12) {
		...
		printf
		    ("./a.out alfa beta gamma sfX sfY sfZ tX tY tZ outputName inputName\n");
		printf("Where:\n");
